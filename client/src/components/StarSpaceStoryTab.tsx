...
const STORY_CHAPTERS = [
  ...
  },
  {
    ...
    mission: "Complete a full mock exam with 85% accuracy to defeat Lord Confusion",
    reward: 450,
  ...
  },
  {
    ...
    mission: "Solve complex multi-step problems to fully awaken your inner crystal",
    reward: 500,
  ...
  },
  {
    ...
    mission: "Master advanced problem-solving to inspire other students",
    reward: 550,
  ...
  },
  {
    ...
    mission: "Achieve mastery level in all TEKS standards to protect the galaxy",
    reward: 600,
  ...
  },
  {
    ...
    mission: "Demonstrate consistent excellence to inspire the next generation",
    reward: 750,
    planet: "StarSpace Academy",
    unlocked: false
  },
  {
    ...
    mission: "Continue growing and helping others discover their potential",
    reward: 1000,
