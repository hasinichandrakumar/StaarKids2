      ...
      <Card className="bg-gradient-to-br from-yellow-50 to-yellow-100 border-yellow-200 hover:shadow-lg transition-shadow">
        ...
        <CardContent>
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-yellow-800">{stats.dailyStarPower}</span>
          </div>
          <p className="text-xs text-yellow-600 mt-1">Starpower earned today</p>
        </CardContent>
      </Card>

      {/* Weekly Starpower - Medium */}
      <Card className="bg-gradient-to-br from-amber-50 to-amber-100 border-amber-200 hover:shadow-lg transition-shadow">
        ...
        <CardContent>
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-amber-800">{stats.weeklyStarPower}</span>
          </div>
          <p className="text-xs text-amber-600 mt-1">Starpower earned this week</p>
        </CardContent>
      </Card>

      {/* All-Time Starpower - Darkest */}
